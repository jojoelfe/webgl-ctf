var V=Object.defineProperty,M=Object.defineProperties;var K=Object.getOwnPropertyDescriptors;var F=Object.getOwnPropertySymbols;var W=Object.prototype.hasOwnProperty,G=Object.prototype.propertyIsEnumerable;var D=(r,t,e)=>t in r?V(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e,_=(r,t)=>{for(var e in t||(t={}))W.call(t,e)&&D(r,e,t[e]);if(F)for(var e of F(t))G.call(t,e)&&D(r,e,t[e]);return r},P=(r,t)=>M(r,K(t));import{e as c,b as Y,i as X,t as f,r as J,f as k,w as U,s as Q,g as E,I as z,h as B,$ as l,l as u,_ as g,O as Z,j as $,F as R,k as x,S as tt,m as L,n as S,p as et}from"./index.82a58d4f.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ot(r){return c(P(_({},r),{state:!0}))}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const rt=Y(class extends X{constructor(r){if(super(r),r.type!==f.PROPERTY&&r.type!==f.ATTRIBUTE&&r.type!==f.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!J(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[t]){if(t===k||t===U)return t;const e=r.element,o=r.name;if(r.type===f.PROPERTY){if(t===e[o])return k}else if(r.type===f.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(o))return k}else if(r.type===f.ATTRIBUTE&&e.getAttribute(o)===t+"")return k;return Q(r),t}});/*! *****************************************************************************
...
***************************************************************************** */function O(r,t){var e={};for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&t.indexOf(o)<0&&(e[o]=r[o]);if(r!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,o=Object.getOwnPropertySymbols(r);i<o.length;i++)t.indexOf(o[i])<0&&Object.prototype.propertyIsEnumerable.call(r,o[i])&&(e[o[i]]=r[o[i]]);return e}function h(r,t,e,o){var i=arguments.length,s=i<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(r,t,e,o);else for(var n=r.length-1;n>=0;n--)(a=r[n])&&(s=(i<3?a(s):i>3?a(t,e,s):a(t,e))||s);return i>3&&s&&Object.defineProperty(t,e,s),s}const it=()=>E`<svg
...
OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */function v(r,t,e,o){var i=arguments.length,s=i<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(r,t,e,o);else for(var n=r.length-1;n>=0;n--)(a=r[n])&&(s=(i<3?a(s):i>3?a(t,e,s):a(t,e))||s);return i>3&&s&&Object.defineProperty(t,e,s),s}/*! *****************************************************************************
Copyright (c) Microsoft Corporation.
...
OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */function A(r,t,e,o){var i=arguments.length,s=i<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(r,t,e,o);else for(var n=r.length-1;n>=0;n--)(a=r[n])&&(s=(i<3?a(s):i>3?a(t,e,s):a(t,e))||s);return i>3&&s&&Object.defineProperty(t,e,s),s}function ct(r){class t extends r{renderAnchor({id:o,className:i,ariaHidden:s,labelledby:a,tabindex:n,anchorContent:N=l`<slot></slot>`}){return l`<a
                    id=${o}
                    class=${u(i)}
                    href=${u(this.href)}
                    ...
                    tabindex=${u(n)}
                    rel=${u(this.rel)}
                >${N}</a>`}}return g([c({reflect:!0})],t.prototype,"download",void 0),g([c()],t.prototype,"label",void 0),g([c({reflect:!0})],t.prototype,"href",void 0),g([c({reflect:!0})],t.prototype,"target",void 0),g([c({reflect:!0})],t.prototype,"rel",void 0),t}const w=Symbol("slotElementObserver"),H=Symbol("startObserving"),y=Symbol("slotContentIsPresent");function at(r,t){var e;const o=Array.isArray(t)?t:[t];class i extends r{constructor(){super(...arguments);this[e]=new Map,this.managePresenceObservedSlot=()=>{o.forEach(a=>{this[y].set(a,!!this.querySelector(a))}),this.requestUpdate()}}get slotContentIsPresent(){if(o.length===1)return this[y].get(o[0])||!1;throw new Error("Multiple selectors provided to `ObserveSlotPresence` use `getSlotContentPresence(selector: string)` instead.")}getSlotContentPresence(a){if(this[y].has(a))return this[y].get(a)||!1;throw new Error("The provided selector `` is not being observed.")}[(e=y,H)](){const a={childList:!0,subtree:!0};this[w]||(this[w]=new MutationObserver(this.managePresenceObservedSlot)),this[w].observe(this,a),this.managePresenceObservedSlot()}connectedCallback(){super.connectedCallback(),this[H]()}disconnectedCallback(){this[w].disconnect(),super.disconnectedCallback()}}return i}function nt(r){return typeof window!="undefined"&&window.navigator!=null?r.test(window.navigator.userAgent):!1}function lt(r){return typeof window!="undefined"&&window.navigator!=null?r.test(window.navigator.platform):!1}function dt(){return lt(/^iPhone/)}function ut(){return nt(/Android/)}class q extends ct(Z(at(R,'[slot="icon"]'))){constructor(){super();this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return this.slotHasContent}get focusElement(){return this}get buttonContent(){const t=[l`
...
`;var bt=ht;const vt=()=>E`<svg
  ...
  >
    ...
    />
  </svg>`;class ft extends z{render(){return B(l),vt()}}customElements.define("sp-icon-corner-triangle300",ft);const xt={s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"},gt=300;let j;class b extends tt(q){constructor(){super();this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{if(!this.toggles)return;this.selected=!this.selected,this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected)},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[mt,bt]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(){this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),j=setTimeout(()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))},gt)}onPointerup(){clearTimeout(j),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:e,altKey:o}=t;(e==="Space"||o&&e==="ArrowDown")&&(t.preventDefault(),e==="ArrowDown"&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:e,altKey:o}=t;(e==="Space"||o&&e==="ArrowDown")&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(l`
                <sp-icon-corner-triangle300
                    class="hold-affordance ${xt[this.size]}"
                ></sp-icon-corner-triangle300>
            `),t}updated(t){super.updated(t);const o=this.role==="button"&&(this.selected||this.toggles);(t.has("selected")||t.has("role"))&&(o?this.setAttribute("aria-pressed",this.selected?"true":"false"):this.removeAttribute("aria-pressed"))}}v([c({type:Boolean,reflect:!0})],b.prototype,"emphasized",void 0);v([c({type:Boolean,reflect:!0,attribute:"hold-affordance"})],b.prototype,"holdAffordance",void 0);v([c({type:Boolean,reflect:!0})],b.prototype,"quiet",void 0);v([c({reflect:!0})],b.prototype,"role",void 0);v([c({type:Boolean,reflect:!0})],b.prototype,"selected",void 0);v([c({type:Boolean,reflect:!0})],b.prototype,"toggles",void 0);v([c({reflect:!0})],b.prototype,"variant",void 0);v([c({type:String})],b.prototype,"value",null);customElements.define("sp-action-button",b);/*! *****************************************************************************
Copyright (c) Microsoft Corporation.
...
OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */function p(r,t,e,o){var i=arguments.length,s=i<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(r,t,e,o);else for(var n=r.length-1;n>=0;n--)(a=r[n])&&(s=(i<3?a(s):i>3?a(t,e,s):a(t,e))||s);return i>3&&s&&Object.defineProperty(t,e,s),s}function yt(r,t,e){const o=r.getAttribute(t);let i=o?o.split(/\s+/):[];i=i.filter(s=>!e.find(a=>s===a)),i.length?r.setAttribute(t,i.join(" ")):r.removeAttribute(t)}function kt(r,t,e){const o=Array.isArray(e)?e:[e],i=r.getAttribute(t),s=i?i.split(/\s+/):[];return o.every(n=>s.indexOf(n)>-1)?()=>{}:(s.push(...o),r.setAttribute(t,s.join(" ")),()=>yt(r,t,o))}class I{constructor(t,{mode:e}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:o})=>{this.handleHelpText(o),this.handleNegativeHelpText(o)},this.host=t,this.instanceCount=I.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=e}get isInternal(){return this.mode==="internal"}render(t){return l`
        ...
        `}addId(){const t=this.helpTextElement?this.helpTextElement.id:this.id;this.conditionId=kt(this.host,"aria-describedby",t),this.host.hasAttribute("tabindex")&&(this.previousTabindex=parseFloat(this.host.getAttribute("tabindex"))),this.host.tabIndex=0}removeId(){this.conditionId&&(this.conditionId(),delete this.conditionId),!this.helpTextElement&&(this.previousTabindex?this.host.tabIndex=this.previousTabindex:this.host.removeAttribute("tabindex"))}handleHelpText(t){if(this.isInternal)return;this.helpTextElement&&this.helpTextElement.id===this.id&&this.helpTextElement.removeAttribute("id"),this.removeId();const o=t.assignedElements()[0];this.helpTextElement=o,o&&(o.id||(o.id=this.id),this.addId())}handleNegativeHelpText(t){if(t.name!=="negative-help-text")return;t.assignedElements().forEach(o=>o.variant="negative")}}I.instanceCount=0;function wt(r,{mode:t}={mode:"internal"}){class e extends r{constructor(){super(...arguments);this.helpTextManager=new I(this,{mode:t})}get helpTextId(){return this.helpTextManager.id}renderHelpText(i){return this.helpTextManager.render(i)}}return e}const zt=()=>E`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`;class qt extends z{render(){return B(l),zt()}}customElements.define("sp-icon-checkmark100",qt);let T;const It=function(r,...t){return T?T(r,...t):t.reduce((e,o,i)=>e+o+r[i+1],r[0])},Ct=r=>{T=r},Ut=({width:r=24,height:t=24,hidden:e=!1,title:o="Alert"}={})=>It`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${r}"
  ...
  >
    ...
    />
  </svg>`;class Tt extends z{render(){return Ct(l),Ut({hidden:!this.label,title:this.label})}}customElements.define("sp-icon-alert",Tt);const Et=x`
...
`;var At=$t;const Ft=["text","url","tel","email","password"];class d extends wt(R){constructor(){super(...arguments);this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[Bt,At]}get type(){var t;return(t=Ft.find(e=>e===this._type))!==null&&t!==void 0?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const o=this.inputElement.selectionStart-1;this.inputElement.value=this.value.toString(),this.inputElement.setSelectionRange(o,o);return}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!0}onBlur(){this.focused=!1}renderStateIcons(){return this.invalid?l`
        ...
        `}updated(t){(t.has("value")||t.has("required")&&this.required)&&this.checkValidity()}checkValidity(){let t=this.inputElement.checkValidity();return(this.required||this.value&&this.pattern)&&((this.disabled||this.multiline)&&this.pattern&&(t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())),typeof this.minlength!="undefined"&&(t=t&&this.value.toString().length>this.minlength),this.valid=t,this.invalid=!t),t}}p([c({attribute:"allowed-keys"})],d.prototype,"allowedKeys",void 0);p([c({type:Boolean,reflect:!0})],d.prototype,"focused",void 0);p([$(".input")],d.prototype,"inputElement",void 0);p([c({type:Boolean,reflect:!0})],d.prototype,"invalid",void 0);p([c()],d.prototype,"label",void 0);p([c()],d.prototype,"placeholder",void 0);p([c({attribute:"type",reflect:!0})],d.prototype,"_type",void 0);p([ot()],d.prototype,"type",null);p([c()],d.prototype,"pattern",void 0);p([c({type:Boolean,reflect:!0})],d.prototype,"grows",void 0);p([c({type:Number})],d.prototype,"maxlength",void 0);p([c({type:Number})],d.prototype,"minlength",void 0);p([c({type:Boolean,reflect:!0})],d.prototype,"multiline",void 0);p([c({type:Boolean,reflect:!0})],d.prototype,"readonly",void 0);p([c({type:Boolean,reflect:!0})],d.prototype,"valid",void 0);p([c({type:String})],d.prototype,"value",null);p([c({type:Boolean,reflect:!0})],d.prototype,"quiet",void 0);p([c({type:Boolean,reflect:!0})],d.prototype,"required",void 0);p([c({type:String,reflect:!0})],d.prototype,"autocomplete",void 0);class Dt extends d{constructor(){super(...arguments);this._value=""}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}}p([c({type:String})],Dt.prototype,"value",null);const _t=x`
...
`;var St=Lt;const Ot=5,C="-",Ht={"\uFF11":"1","\uFF12":"2","\uFF13":"3","\uFF14":"4","\uFF15":"5","\uFF16":"6","\uFF17":"7","\uFF18":"8","\uFF19":"9","\uFF10":"0","\u3001":",","\uFF0C":",","\u3002":".","\uFF0E":".","\uFF05":"%","\uFF0B":"+",\u30FC:"-"};class m extends d{constructor(){super(...arguments);this.focused=!1,this._forcedUnit="",this.formatOptions={},this.hideStepper=!1,this.indeterminate=!1,this.keyboardFocused=!1,this.resolvedLanguage=document.documentElement.lang||navigator.language,this.stepperActive=!1,this.stepModifier=10,this._value=NaN,this._trackingValue="",this.changeCount=0,this.wasIndeterminate=!1}static get styles(){return[...super.styles,St,Pt]}set value(t){const e=this.validateInput(t);if(e===this.value)return;const o=this._value;this._value=e,this.requestUpdate("value",o)}get value(){return this._value}get inputValue(){return this.indeterminate?this.formattedValue:this.inputElement.value}get valueAsString(){return this._value.toString()}set valueAsString(t){this.value=this.numberParser.parse(t)}get formattedValue(){return isNaN(this.value)?"":this.numberFormatter.format(this.value)+(this.focused?"":this._forcedUnit)}convertValueToNumber(t){return this.numberParser.parse(t)}get _step(){var t;return typeof this.step!="undefined"?this.step:((t=this.formatOptions)===null||t===void 0?void 0:t.style)==="percent"?.01:1}handlePointerdown(t){if(t.button!==0){t.preventDefault();return}this.stepperActive=!0,this.buttons.setPointerCapture(t.pointerId);const e=this.buttons.children[0].getBoundingClientRect(),o=this.buttons.children[1].getBoundingClientRect();this.findChange=i=>{i.clientX>=e.x&&i.clientY>=e.y&&i.clientX<=e.x+e.width&&i.clientY<=e.y+e.height?this.change=s=>this.increment(s.shiftKey?this.stepModifier:1):i.clientX>=o.x&&i.clientY>=o.y&&i.clientX<=o.x+o.width&&i.clientY<=o.y+o.height&&(this.change=s=>this.decrement(s.shiftKey?this.stepModifier:1))},this.findChange(t),this.startChange(t)}startChange(t){this.changeCount=0,this.doChange(t),this.safty=setTimeout(()=>{this.doNextChange(t)},400)}doChange(t){this.change(t)}handlePointermove(t){this.findChange(t)}handlePointerup(t){this.buttons.releasePointerCapture(t.pointerId),cancelAnimationFrame(this.nextChange),clearTimeout(this.safty),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})),this.stepperActive=!1}doNextChange(t){return this.changeCount+=1,this.changeCount%Ot===0&&this.doChange(t),requestAnimationFrame(()=>{this.nextChange=this.doNextChange(t)})}stepBy(t){if(this.disabled||this.readonly)return;const e=typeof this.min!="undefined"?this.min:0;let o=this.value;o+=t*this._step,isNaN(this.value)?this.value=e:this.value=o,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),this.indeterminate=!1,this.focus()}increment(t=1){this.stepBy(1*t)}decrement(t=1){this.stepBy(-1*t)}handleKeydown(t){switch(t.code){case"ArrowUp":t.preventDefault(),this.increment(t.shiftKey?this.stepModifier:1),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}));break;case"ArrowDown":t.preventDefault(),this.decrement(t.shiftKey?this.stepModifier:1),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}));break}}onScroll(t){t.preventDefault();const e=t.shiftKey?t.deltaX/Math.abs(t.deltaX):t.deltaY/Math.abs(t.deltaY);e!==0&&!isNaN(e)&&this.stepBy(e*(t.shiftKey?this.stepModifier:1))}onFocus(){super.onFocus(),this._trackingValue=this.inputValue,this.keyboardFocused=!0,this.addEventListener("wheel",this.onScroll)}onBlur(){super.onBlur(),this.keyboardFocused=!1,this.removeEventListener("wheel",this.onScroll)}handleFocusin(){this.focused=!0,this.keyboardFocused=!0}handleFocusout(){this.focused=!1,this.keyboardFocused=!1}handleChange(){const t=this.convertValueToNumber(this.inputValue);if(this.wasIndeterminate&&(this.wasIndeterminate=!1,this.indeterminateValue=void 0,isNaN(t))){this.indeterminate=!0;return}this.value=t,super.handleChange()}handleInput(){this.indeterminate&&(this.wasIndeterminate=!0,this.indeterminateValue=this.value,this.inputElement.value=this.inputElement.value.replace(C,""));const{value:t,selectionStart:e}=this.inputElement,o=t.split("").map(n=>Ht[n]||n).join("");if(this.numberParser.isValidPartialNumber(o)){const n=this.convertValueToNumber(o);!o&&this.indeterminateValue?(this.indeterminate=!0,this._value=this.indeterminateValue):(this.indeterminate=!1,this._value=this.validateInput(n)),this._trackingValue=o,this.inputElement.value=o;return}const i=o.length,s=this._trackingValue.length,a=(e||i)-(i-s);this.inputElement.value=this.indeterminate?C:this._trackingValue,this.inputElement.setSelectionRange(a,a)}validateInput(t){if(typeof this.min!="undefined"&&(t=Math.max(this.min,t)),typeof this.max!="undefined"&&(t=Math.min(this.max,t)),this.step){const e=typeof this.min!="undefined"?this.min:0,o=(t-e)%this.step;if(o===0||(Math.round(o/this.step)===1?t+=this.step-o:t-=o),typeof this.max!="undefined")for(;t>this.max;)t-=this.step}return t}get displayValue(){const t=this.focused?"":C;return this.indeterminate?t:this.formattedValue}clearNumberFormatterCache(){this._numberFormatter=void 0,this._numberParser=void 0}get numberFormatter(){if(!this._numberFormatter||!this._numberFormatterFocused){const t=this.formatOptions,{style:e,unit:o,unitDisplay:i}=t,s=O(t,["style","unit","unitDisplay"]);e!=="unit"&&(s.style=e),this._numberFormatterFocused=new L(this.resolvedLanguage,s);try{this._numberFormatter=new L(this.resolvedLanguage,this.formatOptions),this._forcedUnit="",this._numberFormatter.format(1)}catch{e==="unit"&&(this._forcedUnit=o),this._numberFormatter=this._numberFormatterFocused}}return this.focused?this._numberFormatterFocused:this._numberFormatter}get numberParser(){if(!this._numberParser||!this._numberParserFocused){const t=this.formatOptions,{style:e,unit:o,unitDisplay:i}=t,s=O(t,["style","unit","unitDisplay"]);e!=="unit"&&(s.style=e),this._numberParserFocused=new S(this.resolvedLanguage,s);try{this._numberParser=new S(this.resolvedLanguage,this.formatOptions),this._forcedUnit="",this._numberParser.parse("0")}catch{e==="unit"&&(this._forcedUnit=o),this._numberParser=this._numberParserFocused}}return this.focused?this._numberParserFocused:this._numberParser}renderField(){return this.autocomplete="off",l`
            ${super.renderField()}
            ${this.hideStepper?l``:l`
                  ...
                  `}
        `}update(t){(t.has("formatOptions")||t.has("resolvedLanguage"))&&this.clearNumberFormatterCache(),super.update(t)}firstUpdated(t){super.firstUpdated(t),this.multiline=!1,this.addEventListener("keydown",this.handleKeydown)}updated(t){if(t.has("value")||t.has("max")||t.has("min")||t.has("min")){const e=this.numberParser.parse(this.inputValue.replace(this._forcedUnit,""));this.value=e}if(t.has("min")||t.has("formatOptions")){let e="numeric";const o=typeof this.min!="undefined"&&this.min<0,{maximumFractionDigits:i}=this.formatOptions,s=i&&i>0;dt()?o?e="text":s&&(e="decimal"):ut()&&(o?e="numeric":s&&(e="decimal")),this.inputElement.inputMode=e}}connectedCallback(){super.connectedCallback(),this.resolveLanguage()}disconnectedCallback(){this.resolveLanguage(),super.disconnectedCallback()}resolveLanguage(){const t=new CustomEvent("sp-language-context",{bubbles:!0,composed:!0,detail:{callback:e=>{this.resolvedLanguage=e}},cancelable:!0});this.dispatchEvent(t)}}h([$(".buttons")],m.prototype,"buttons",void 0);h([c({type:Boolean,reflect:!0})],m.prototype,"focused",void 0);h([c({type:Object,attribute:"format-options"})],m.prototype,"formatOptions",void 0);h([c({type:Boolean,reflect:!0,attribute:"hide-stepper"})],m.prototype,"hideStepper",void 0);h([c({type:Boolean,reflect:!0})],m.prototype,"indeterminate",void 0);h([c({type:Boolean,reflect:!0,attribute:"keyboard-focused"})],m.prototype,"keyboardFocused",void 0);h([c({type:Number})],m.prototype,"max",void 0);h([c({type:Number})],m.prototype,"min",void 0);h([c({attribute:!1})],m.prototype,"resolvedLanguage",void 0);h([c({type:Number})],m.prototype,"step",void 0);h([c({type:Number,reflect:!0,attribute:"step-modifier"})],m.prototype,"stepModifier",void 0);h([c({type:Number})],m.prototype,"value",null);customElements.define("sp-number-field",m);
